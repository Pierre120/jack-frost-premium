...
<div class="checkout-container">
	...
	<p class="reminder">
		Your order has been successfully placed and is now processing. A representative will contact you
		soon. Please screenshot and take note of your Order Number before leaving this page
	</p>
	<p class="order-num">
		<span>
			Order #{Number(data.order_number.number).toString().padStart(5, '0') ?? '*****'}
