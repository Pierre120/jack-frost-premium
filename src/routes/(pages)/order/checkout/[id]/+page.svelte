...
<div class="checkout-container">
	...
	<p class="order-num">
		...
		<span class="tooltip {showTooltip ? 'tooltip-open tooltip-right' : ''}" data-tip={ showTooltip ? 'Copy order #' : ''}>
			<button on:mouseenter={() => { showTooltip = true }} on:mouseleave={() => { showTooltip = false}} >
...
<style lang="postcss">
	.checkout-container {
		@apply w-full min-h-screen bg-white flex flex-col gap-8 
			items-center justify-center py-4 font-IstokWeb;
	}
