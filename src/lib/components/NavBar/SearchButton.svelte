...
<div class="inline-block min-w-min {placement}">
  <button
    ...
    aria-label="Search"
  > 
    <!-- <img src={searchIcon} alt="Search Icon" class="w-full h-auto opacity-[.6] hover:opacity-75"> -->

    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="stroke-black hover:stroke-primary-red opacity-[.6] hover:opacity-100">
