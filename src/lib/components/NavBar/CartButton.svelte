...
<div class="inline-block min-w-min {placement}">
  ...
  > 
    ...
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="stroke-black hover:stroke-primary-red fill-black hover:fill-primary-red opacity-[.6] hover:opacity-100" width="45.000000pt" height="45.000000pt" viewBox="0 0 45.000000 45.000000" preserveAspectRatio="xMidYMid meet">

      <g transform="translate(0.000000,45.000000) scale(0.100000,-0.100000)"
      fill="inheritColor" stroke="none">
        <path d="M0 430 c0 -14 7 -20 23 -20 20 0 30 -14 65 -86 l41 -87 -20 -38 c-15
        ...
        -20z"/>
        <path d="M107 72 c-22 -24 -21 -35 1 -55 25 -23 39 -21 58 8 16 24 16 27 -1
        45 -22 25 -37 25 -58 2z"/>
        <path d="M338 79 c-44 -25 -3 -93 42 -69 26 14 26 56 1 70 -23 12 -22 12 -43
        -1z"/>
      </g>
    </svg>
  </button>
